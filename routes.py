...
def initialize_data():
    if FlowerCrown.query.count() == 0:
        crowns = [{
            "name":
            "Coroa Elegante Branca",
            "description":
            "Coroa de flores brancas com rosas e lírios, simbolizando pureza e paz.",
            "price":
            180.00,
            "image_url":
            "https://pixabay.com/get/g01c65973cff9a89aecba9673bf60c8dc921fa4f8752e71480d09b1868a06ce4bd6a6f712869d23184ad7f1c9cf23425079a0eb1802f1f4d537018371e0fff24c_1280.jpg"
        }, {
            "name":
            "Coroa Tradicional Vermelha",
            "description":
            "Coroa tradicional com flores vermelhas e folhagem verde, representando amor eterno.",
            "price":
            200.00,
            "image_url":
            "https://pixabay.com/get/g40105fd835c08346206f59c497d834056748330f4aca8bc1a904dc00e371557eb67bd6c68eaa60e06e5f4b31614dd18c86887b1718ae0b4242394ddc8dccea8c_1280.jpg"
        }, {
            "name":
            "Coroa Suave Rosa",
            "description":
            "Delicada coroa com flores rosas e brancas, expressando carinho e ternura.",
            "price":
            190.00,
            "image_url":
            "https://pixabay.com/get/gfd1ec5fa008829e1a5690929435e655bf7f6ebb26104d3a1d34ff1b188fe948fb4ed96a8fc631544651d8adb7b241143939f8b019a7e9cb7d09d3471d053338f_1280.jpg"
        }, {
            "name":
            "Coroa Majestosa Roxa",
            "description":
            "Coroa imponente com flores roxas e lilases, simbolizando dignidade e respeito.",
            "price":
            220.00,
            "image_url":
            "https://pixabay.com/get/g476f2c57ad614a01fb99a317d0553f4e822d1933e3266b661785a9c9943ffb11399e4cd09fa371e600001bc1e17f9afcb7601021b2f79e75701f0a7ff1efc754_1280.jpg"
        }, {
            "name":
            "Coroa Clássica Amarela",
            "description":
            "Coroa clássica com flores amarelas e douradas, transmitindo luz e esperança.",
            "price":
            195.00,
            "image_url":
            "https://pixabay.com/get/g9788778ee508ea0787e289125015c882eaf5a08de09ff23431c23778c781e665e3b765cd72f26ef098583ffb9322fff183aa643e6ee35fc66a9caef4ab83b191_1280.jpg"
        }, {
            "name":
            "Coroa Serena Azul",
            "description":
            "Coroa serena com flores azuis e brancas, evocando tranquilidade e paz celestial.",
            "price":
            210.00,
            "image_url":
            "https://pixabay.com/get/g6e9dab49e087c47431408bb8cc9639837fef48f76c73282c8d708405a488838e967a4308e76c3a637d7aa4d57da9719c8a3d5d366ff478c5a7b9d093fdac06ad_1280.jpg"
        }, {
            "name":
            "Coroa Refinada Mista",
            "description":
            "Coroa refinada com mix de flores coloridas, celebrando uma vida plena.",
            "price":
            230.00,
            "image_url":
            "https://pixabay.com/get/g9c272ff34d5ab0b41297e404adf95edee0379f9970d2ca33590eaf3d0d4511b6a0991a5c0765f15c30eedbcd2ae60d1cdb8247165ece4bc4f67c3d4017f704ec_1280.jpg"
        }, {
            "name":
            "Coroa Nobre Branca Premium",
            "description":
            "Coroa premium com flores brancas nobres, representando pureza e eternidade.",
            "price":
            250.00,
            "image_url":
            "https://pixabay.com/get/g20487e28407f080cde7ad754d2faf2276e517cc7a7a5abf2e8e8ccbf59fbd18fa5005f130d53463a5ca0821d751ae6d4601ea46ef219dbf2ca9924c0ab22eaeb_1280.jpg"
        }, {
            "name":
            "Coroa Delicada Pastel",
            "description":
            "Coroa delicada com tons pastéis suaves, simbolizando gentileza e amor.",
            "price":
            175.00,
            "image_url":
            "https://pixabay.com/get/g05a9b99bc14d8bad2e745060af80e7aa4d32293f051c9be1f1ddffba056076e9ecc1389ce61f2a1f22e2b66f20a486f0dbeac7ae563fb4e398c3d413174f7b42_1280.jpg"
        }]
            ...
            line_items=[{
                'price_data': {
                    ...
                    'product_data': {
                        ...
                        cart['crown_name'],
                        'description':
                        f"Coroa de flores - {cart['custom_message']}"
                        if cart['custom_message'] else "Coroa de flores"
                    },
                    'unit_amount':
                    int(total_amount * 100),  # Stripe uses cents
                },
                'quantity': 1,
            }],
            mode='payment',
...
def payment_success():
    ...
    try:
        ...
        if checkout_session.payment_status == 'paid':
            ...
            # Create order
            order = Order(customer_name=customer_info['customer_name'],
...
def login_required(f):
    ...
    def decorated_function(*args, **kwargs):
        if 'logged_in' not in session:
            flash('É necessário fazer login para aceder a esta página.',
                  'error')
...
def login():
    if request.method == 'POST':
        # ATENÇÃO: Para um site real, use um sistema de autenticação seguro.
        # Estes dados são apenas para exemplo.
...
def add_crown():
    try:
        ...
        new_crown = FlowerCrown(name=name,
...
def edit_crown(crown_id):
    crown = FlowerCrown.query.get_or_404(crown_id)
    try:
        crown.name = request.form.get('name')
        crown.description = request.form.get('description')
        crown.price = float(request.form.get('price'))
        crown.image_url = request.form.get('image_url')
